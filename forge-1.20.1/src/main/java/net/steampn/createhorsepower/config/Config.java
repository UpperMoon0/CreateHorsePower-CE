...
public class Config implements CHPConfig {
    ...
    // ==========================================
    public static final ForgeConfigSpec.IntValue BASE_CREATURE_RPM;
    public static final ForgeConfigSpec.IntValue SMALL_CREATURE_STRESS;
    public static final ForgeConfigSpec.IntValue MEDIUM_CREATURE_STRESS;
    public static final ForgeConfigSpec.IntValue LARGE_CREATURE_STRESS;
    public static final ForgeConfigSpec.DoubleValue POOR_MULTIPLIER;
    public static final ForgeConfigSpec.DoubleValue NORMAL_MULTIPLIER;
    public static final ForgeConfigSpec.DoubleValue GREAT_MULTIPLIER;
    public static final ForgeConfigSpec.ConfigValue<List<? extends String>> POOR_PATH;
    public static final ForgeConfigSpec.ConfigValue<List<? extends String>> NORMAL_PATH;
    public static final ForgeConfigSpec.ConfigValue<List<? extends String>> GREAT_PATH;
    public static final ForgeConfigSpec.ConfigValue<List<? extends String>> SMALL_CREATURES;
    public static final ForgeConfigSpec.ConfigValue<List<? extends String>> MEDIUM_CREATURES;
    public static final ForgeConfigSpec.ConfigValue<List<? extends String>> LARGE_CREATURES;

    // ==========================================
    // BALANCE (1.2+)
    // ==========================================
    public static final ForgeConfigSpec.DoubleValue GLOBAL_RPM_MULTIPLIER;
    public static final ForgeConfigSpec.DoubleValue GLOBAL_STRESS_MULTIPLIER;
    public static final ForgeConfigSpec.BooleanValue ENABLE_INDIVIDUAL_ANIMAL_STATS;
    public static final ForgeConfigSpec.DoubleValue MIN_SPEED_SCALING_CLAMP;
    public static final ForgeConfigSpec.DoubleValue MAX_SPEED_SCALING_CLAMP;
    public static final ForgeConfigSpec.DoubleValue MIN_HEALTH_SCALING_CLAMP;
    public static final ForgeConfigSpec.DoubleValue MAX_HEALTH_SCALING_CLAMP;

    // ==========================================
    // WORKERS (1.2+)
    // ==========================================
    public static final ForgeConfigSpec.BooleanValue ALLOW_BABIES;
    public static final ForgeConfigSpec.BooleanValue REQUIRE_TAMED_HORSE;
    public static final ForgeConfigSpec.BooleanValue ALLOW_UNDEAD_WORKERS;
    public static final ForgeConfigSpec.DoubleValue WORKER_GROUND_SPEED_SCALE;
    public static final ForgeConfigSpec.DoubleValue MIN_WORKER_GROUND_SPEED;
    public static final ForgeConfigSpec.DoubleValue MAX_WORKER_GROUND_SPEED;
    public static final ForgeConfigSpec.BooleanValue DEBUG_LOGGING;

    // ==========================================
    // PATH (1.2+)
    // ==========================================
    public static final ForgeConfigSpec.EnumValue<PathEvaluationMode> PATH_EVALUATION_MODE;
    public static final ForgeConfigSpec.BooleanValue ENABLE_PATH_STRESS_SCALING;
    public static final ForgeConfigSpec.DoubleValue MINIMUM_PATH_COVERAGE;
    ...
    private static boolean validateMobName(final Object obj) {
        return obj instanceof final String mobName && BuiltInRegistries.ENTITY_TYPE.containsKey(new ResourceLocation(mobName));
    }

    private static boolean validateBlockName(final Object obj) {
        return obj instanceof final String blockName && BuiltInRegistries.BLOCK.containsKey(new ResourceLocation(blockName));
    }

    // ==========================================
    // CHPConfig (loader-agnostic view for common logic)
    // ==========================================
    @Override public int baseCreatureRpm() { return BASE_CREATURE_RPM.get(); }
    @Override public int smallCreatureStress() { return SMALL_CREATURE_STRESS.get(); }
    @Override public int mediumCreatureStress() { return MEDIUM_CREATURE_STRESS.get(); }
    @Override public int largeCreatureStress() { return LARGE_CREATURE_STRESS.get(); }
